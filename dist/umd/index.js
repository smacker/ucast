(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@ucast/core')) :
  typeof define === 'function' && define.amd ? define(['exports', '@ucast/core'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.ucast = global.ucast || {}, global.ucast.dynamo = {}), global.ucast.core));
  ...
  function createDynamoInterpreter(operators) {
    var interpret = core.createInterpreter(operators);
  ...
  exports.and = and;
  exports.createDynamoInterpreter = createDynamoInterpreter;
  exports.eq = eq;
